...
func easyjson8092efb6DecodeGithubComOlivereElasticV8(in *jlexer.Lexer, out *bulkDeleteRequestCommandOp) {
...
func easyjson8092efb6EncodeGithubComOlivereElasticV8(out *jwriter.Writer, in bulkDeleteRequestCommandOp) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Index != "" {
...
func (v bulkDeleteRequestCommandOp) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8092efb6EncodeGithubComOlivereElasticV8(&w, v)
...
func (v *bulkDeleteRequestCommandOp) UnmarshalJSON(data []byte) error {
	...
	easyjson8092efb6DecodeGithubComOlivereElasticV8(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *bulkDeleteRequestCommandOp) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8092efb6DecodeGithubComOlivereElasticV8(l, v)
}
func easyjson8092efb6DecodeGithubComOlivereElasticV81(in *jlexer.Lexer, out *bulkDeleteRequestCommand) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		in.Skip()
	} else {
...
func easyjson8092efb6EncodeGithubComOlivereElasticV81(out *jwriter.Writer, in bulkDeleteRequestCommand) {
...
func (v bulkDeleteRequestCommand) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8092efb6EncodeGithubComOlivereElasticV81(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *bulkDeleteRequestCommand) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson8092efb6DecodeGithubComOlivereElasticV81(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *bulkDeleteRequestCommand) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8092efb6DecodeGithubComOlivereElasticV81(l, v)
}
